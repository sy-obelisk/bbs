/*!
 * hui.widgets.js 1.0.2 (2015-03-05, 17:33)
...
(function (global) {
    ...
    // override the jQuery cleanData method.
    ...
    hui.Widget.prototype = {
        ...
        _createWidget: function (element, options) {
            ...
            self.uuid = widget_uuid++;
            self.ns = "." + self.widgetName + self.uuid;
            ...
            self._init();
            hui.widgetInstances[self.uuid + ''] = self;
        },
...
(function ($) {
    ...
    HUI.Widget.extend('Accordion', {
        ...
        _bindEvents: function () {
            ...
            self.element.on(eventName, o.header, function () {
                var $this = $(this);
        ...
        _processPanels: function () {
            ...
            if (o.header) {
                ...
                ele.children("[title]").each(function (i, el) {
                    $(el).prev().addClass("hui-accordion-title");
                });
            }
...
(function ($) {
    ...
    if (HUI.isIE) { //hack ie浏览器刷新页面input只保留ui中check状态,js获取不了check值
        window.onbeforeunload = function () {
            if(HUI && HUI.widgets && HUI.widgets.Checkbox && HUI.widgets.Checkbox.inputs){
...
(function($) {
	...
	HUI.Widget.extend("Tabs", {
		...
		_getList: function() {
			return this.tabList || this.element.children("ol,ul");
		},
    ...
    HUI.define(["hui.widget.core"], function() {
        ...
        HUI.Widget.extend("Progressbar", {
            ...
            _setOption: function(key, value) {
                ...
                HUI.Widget._setOption.prototype.call(this, arguments);
            },
