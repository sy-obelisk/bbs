(function (D) {
    var E = D.env, doc = document, docurl = doc.location.href, share = null, lookup = [], ci = E.compId, loaded = false, oms = ci >= 20000000, ua = navigator.userAgent.toLowerCase(), id_s = "looyu_id", id_l = "looyu_" + ci, localdb, localtemp, homepage = oms && "http://www.looyuoms.com" || "http://www.talk99.cn", dct = [], sametime = 120, fpath = E.file + "/../default/", conhtml, site = E.subComp || 0, winopt = "height=450,width=650,directories=no,location=no,menubar=no,resizable=yes,status=no,toolbar=no,top=100,left=200", supportFlash = (function () {
        ...
        var re = /^http(?:s?):\/\/([\.\w\d\-\u4E00-\u9FA5]+)/i;
        return docurl.match(re)[1]
    })();
    var $ = function (id) {
        return doc.getElementById(id)
    }, browser = {strict:doc.compatMode == "CSS1Compat", webkit:/webkit/i.test(ua), msie:/msie/i.test(ua) && !/opera/i.test(ua), gecko:!/webkit/i.test(ua) && /gecko/i.test(ua), safari:/safari/i.test(ua) && !/maxthon/i.test(ua), cacheswf:/theworld|se\s\d+|greenbrowser/i.test(ua), android:ua.indexOf("Android") > -1 || ua.indexOf("Linux") > -1, iPhone:ua.indexOf("iPhone") > -1 || ua.indexOf("Mac") > -1, iPad:ua.indexOf("iPad") > -1};
    ...
    var blk = function (s) {
        ...
        return !p && cterPos(w, h) || p == 1 && {left:5, bottom:5} || p == 2 && {right:5, bottom:5}
    };
    var have = doc.compareDocumentPosition ? function (a, b) {
        ...
        D.resp = null;
        var u = url + "&x=" + (+new Date()), h = doc.getElementsByTagName("head")[0], s = createEle("script", {type:"text/javascript", src:u}, h);
        ...
        getCookie(id_s) != localdb && setCookie(id_s, localdb);
        setCookie(id_l, getCookie(id_l) || localtemp, sametime);
        supportFlash && share && share.upvid(ci, site, E.vId);
        ...
        return{c:"a", i:ci, v:E.vId, u:E.uId, p:E.pId || "", ref:E.refer, site:site, h:h, w:u, scn:(screen.width + "*" + screen.height), t:this.type || "", ct:E.counter, r:E.reseve || "", p0:E.p0 || docurl}
    };
    D.util = {openChat:openChat, chatURL:chatURL, fly:fly, openPhone:function (pm) {
    ...
    extend(Function.prototype, {doyoodg:function (obj, args) {
        var method = this;
        return function () {
    ...
    extend(timer.prototype, {addTask:function (f) {
    ...
    var flier = function (v, g, w, h, pos) {
        extend(this, {obj:v, handle:(typeof g == "string") ? $(g) : g, width:w || v.offsetWidth, height:h || v.offsetHeight, onmousemove:this.drag.doyoodg(this), onmouseup:this.drop.doyoodg(this), pos:pos});
        if (this.handle) {
            this.handle.style.cursor = "move";
            this.handle.onmousedown = this.beginDrag.doyoodg(this)
        }
    };
    extend(flier.prototype, {beginDrag:function (e) {
        e = e || event;
        ...
        var b = getBody();
        return{x:newX > 0 && newX < b.clientWidth - this.width + sLeft(), y:newY > 0 && newY < b.clientHeight - this.height + sTop()}
    }, drag:function (e) {
        e = e || event;
    ...
    extend(Mask.prototype, {showDiv:function () {
    ...
    extend(DP.prototype, {defUI:function () {
    ...
    extend(M.prototype, {defUI:function (mark) {
        ...
        this.denyLink.onclick = this.deny.doyoodg(this);
        ...
        switch (r.c) {
            case"a":
                ...
                if (t <= 10 && this.autoDirectChat > -1 && this.status) {
                    setTimeout(function () {
                        m.force(null, 1)
        ...
        if (t != 4 && !curF) {
            ...
            curF = createEle("iframe", {id:"doyoo_f_frame", src:(t == 1 ? "about:blank" : nurl), frameborder:"0"});
            ...
            try {
                if (this.mini == 1) {
                    ...
                    var t = curF.contentWindow.document;
                    t.writeln(s)
                }
        ...
        if (!fChat) {
            ...
            fChat.style.backgroundImage = "url(" + fpath + "images/mini/" + (this.miniStyle || 1) + ".gif?131127)";
            fChat.innerHTML = '<div id="doyoo_f_head"><div id="doyoo_f_close"></div><div id="doyoo_f_min"></div></div><div  id="doyoo_f_main"></div>';
            show(fChat);
            fMin = createEle("div", {id:"doyoo_f_minPanel"});
            fMin.style.backgroundImage = "url(" + fpath + "images/mini/min_" + (this.miniStyle || 1) + ".gif?13117)";
            fMin.innerHTML = '<div class="inner"><div id="doyoo_f_restore"></div><div id="doyoo_f_end"></div></div>';
            var closeForce = function () {
                var f = $("doyoo_f_work");
                f.src = "about:blank";
                hide(fChat)
            };
            var minForce = function () {
                hide(fChat);
                show(fMin)
            };
            var restoreForce = function () {
                show(fChat);
                hide(fMin)
            };
            attachE($("doyoo_f_close"), "click dblclick", closeForce);
            attachE($("doyoo_f_end"), "click,dblclick", closeForce);
            attachE($("doyoo_f_min"), "click,dblclick", minForce);
            attachE($("doyoo_f_restore"), "click,dblclick", restoreForce);
            fly(fMin, null, 248, 30, {right:30, bottom:10})
        }
        ...
        slide(fChat, 2, pos);
        fly(fChat, "doyoo_f_head", 411, 263, pos)
    }, doEvent:function (et) {
        var build = function (e) {
            var fc = (e.m && e.m.indexOf("<FORCE>") != -1) || e.e == "s1";
            return{type:(e.e == "11" ? 1 : 0), force:fc, cId:e.c, sId:e.s, dId:e.d, m:fc ? 0 : e.m, g:e.g}
        }, me = this;
        this.chat = build(et);
        switch (et.e) {
            case"11":
    ...
    extend(P.prototype, {defUI:function () {
        this[this.category + "Builder"]()
    }, builder:function () {
        ...
        var o = this.obj;
        if (this.mode == 2) {
            extend(o.style, {width:(this.width + "px"), height:(this.height + "px"), background:("url(" + this.panelBG + ") no-repeat")});
            var hcont = ['<div id="doyoo_panel_main">'], groups = this.customers.groups, celltpl = '<a class="doyoo_panel_cell" style="width:100%;display:block;height:{height}px;line-height:{height}px;background:url({cellbk}) no-repeat left center;{cellMargin}" href="#" onclick="doyoo.util.openChat(\'g={group}\');return false"><span style="{textStyle};height:{height}px;line-height:{height}px;{textMargin}">{groupName}</span></a>';
            for (var i = 0; i < groups.length; i++) {
                var gp = groups[i];
                hcont.push(tpl(celltpl, {height:this.cellHeight, cellbk:(gp.active ? this.cellOnline : this.cellOffline), group:gp.id, groupName:gp.name, cellMargin:this.cellMargin, textStyle:gp.active && this.onlineText || this.offlineText, textMargin:this.textMargin}))
            }
            hcont.push("</div>");
            o.innerHTML = hcont.join("");
            var mp = $("doyoo_panel_main"), stys = this.panelMain.split(" ");
            extend(mp.style, {left:stys[0] + "px", top:stys[1] + "px", width:stys[2] + "px", height:stys[3] + "px"});
            return
        }
        if (this.mode == 1) {
        ...
        var ele = function (et, sn, tar, st, of) {
            var mo = this.mode, sc = ["doyoo_offline", "doyoo_online", "doyoo_offline", "doyoo_offline", "doyoo_offline", "doyoo_other", "doyoo_other", "doyoo_other"], sofft = {sc:["\u7559\u8a00", "\u81ea\u52a9", "\u7535\u8bdd", "\u77ed\u4fe1"], en:["MSG", "AUTO", "CALL", "SMS"], tc:["\u7559\u8a00", "\u81ea\u52a9", "\u96fb\u8a71", "\u7c21\u8a0a"], ru:["MSG", "AUTO", "CALL", "SMS"]}, sont = {sc:["\u5728\u7ebf", "\u5fd9\u788c", "\u79bb\u5f00"], en:["CHAT", "BUSY", "AWAY"], tc:["\u5728\u7dda", "\u5fd9\u788c", "\u96e2\u958b"], ru:["CHAT", "BUSY", "AWAY"]}, ln = E.lang && (sont[E.lang] && E.lang) || "sc", clk = (et != "gw" && et != "d"), h = '<div class="' + (et == "c" ? "group_content" : "group_title") + '" ';
            h += ">";
            if (clk) {
                h += '<div class="' + (st && sc[st] || sc[of + 4]) + '">';
                h += '<div class="doyoo_status">' + (st == 0 ? sofft[ln][of] : sont[ln][st - 1]) + "</div>"
            }
            h += '<a class="doyoo_link" href="#" ';
            if (clk) {
        ...
        var innerTpl = '<div class="doyoo_pan_icon_inner" id="{id}" style="width:{innerW}px;float:{floatPos}"><a href="#" id="{linkId}" style="display:block;width:100%;height:100%;">&nbsp;</a>';
        ...
        for (var i = 0; i < this.regions.length; i++) {
            ...
            var regionTpl = '<a href="#" class="talk99_region" style="left:{l}px;top:{t}px;width:{w}px;height:{h}px;background-image: url({bk})" onclick="{act};return false;">&nbsp;</a>';
            switch (+rgs.type) {
                case 0:
        ...
        if (this.collapse) {
            ...
            var collapseTpl = '<a href="#" class="talk99_collapse" id="{collapseId}" style="width:{collapseW}px;height:{collapseH}px;margin-top:{collapseT}px;float:{collapseFloat};background-image:url({collapseImage})"  collapsed="{collapsed}">&nbsp;</a> ';
    ...
    extend(MsgPanel.prototype, (function () {
        var curl = E.lang || "sc";
        var lang_tip = {sc:"\u8f93\u5165\u60a8\u7684\u7559\u8a00\u4fe1\u606f\uff0c\u6211\u4eec\u4f1a\u5c3d\u5feb\u8054\u7cfb\u60a8\uff01", tc:"\u8f38\u5165\u60a8\u7684\u7559\u8a00\u4fe1\u606f\uff0c\u6211\u5011\u6703\u5118\u5feb\u806f\u7e6b\u60a8\uff01", en:"We will contact you!", ru:""}, lang_name = {sc:"\u59d3\u540d\uff1a", tc:"\u59d3\u540d\uff1a", en:"name", ru:"\u0444.\u0438.\u043e"}, lang_phone = {sc:"\u7535\u8bdd\uff1a", tc:"\u96fb\u8a71\uff1a", en:"phone", ru:"\u2116.\u00a0\u0442\u0435\u043b"}, lang_email = {sc:"\u90ae\u7bb1\uff1a", tc:"\u90f5\u7bb1\uff1a", en:"email", ru:"\u044d\u043b.\u043f\u043e\u0447\u0442\u0430"}, lang_qq = {sc:"Q&nbsp;&nbsp;Q\uff1a", tc:"Q&nbsp;&nbsp;Q\uff1a", en:"Q&nbsp;&nbsp;Q:", ru:"Q&nbsp;&nbsp;Q:"}, lang_submit = {sc:"\u63d0\u4ea4", tc:"\u63d0\u4ea4", en:"submit", ru:"\u0441\u043f\u0430\u0441\u0430\u0442\u044c"}, lang_freePhone = {sc:"\u514D\u8D39\u901A\u8BDD", tc:"\u514D\u8CBB\u901A\u8A71", en:"FreePhone", ru:"\u0431\u0435\u0441\u043f.\u0437\u0432\u043e\u043d\u043e\u043a"};
        var msg_error = {sc:"\u7559\u8A00\u5185\u5BB9\u4E0D\u80FD\u4E3A\u7A7A", tc:"\u7559\u8A00\u5167\u5BB9\u4E0D\u80FD\u70BA\u7A7A", en:"Message cannot be blank.", ru:"\u043f\u0443\u0441\u0442\u043e\u0439\u00a0\u043a\u043e\u043c\u043c\u0435\u043d\u0442"};
        var con_error = {sc:"\u7535\u8BDD\u548C\u90AE\u7BB1\u81F3\u5C11\u8981\u63D0\u4F9B\u4E00\u9879\u4EE5\u65B9\u4FBF\u6211\u4EEC\u8054\u7CFB\u60A8\uFF01", tc:"\u96FB\u8A71\u548C\u90F5\u7BB1\u81F3\u5C11\u8981\u63D0\u4F9B\u4E00\u9805\u4EE5\u4FBF\u6211\u5011\u806F\u7E6B\u60A8\21", en:"phone and email cannot be all blank!", ru:"\u043d\u043e\u043c\u0435\u0440\u00a0\u0442\u0435\u043b.\u0438\u00a0\u044d\u043b.\u043f\u043e\u0447\u0442\u0430\u0000\u0437\u0430\u043f\u043e\u043b\u043d\u044f\u0442\u044c\u00a0\u043e\u0431\u044f\u0437\u0430\u0442\u0435\u043b\u044c\u043d\u043e"};
        var phone_error = {sc:"\u8BF7\u8F93\u5165\u6B63\u786E\u7684\u7535\u8BDD\u53F7\u7801", tc:"\u8ACB\u8F38\u5165\u6B63\u78BA\u7684\u96FB\u8A71\u865F\u78BC", en:"the number is invalid", ru:"\u043d\u0435\u0440\u043f.\u043d\u043e\u043c\u0435\u0440"};
        var email_error = {sc:"\u8BF7\u8F93\u5165\u6B63\u786E\u7684\u90AE\u4EF6\u5730\u5740", tc:"\u8ACB\u8F38\u5165\u6B63\u78BA\u7684\u90F5\u4EF6\u5730\u5740", en:"the email is invalid", ru:"\u043d\u0435\u0440\u043f.\u044d\u043b.\u043f\u043e\u0447\u0442\u0430"};
        var qq_error = {sc:"\u8BF7\u8F93\u5165\u6B63\u786E\u7684qq\u53F7\u7801", tc:"\u8ACB\u8F38\u5165\u6B63\u78BA\u7684qq\u865F\u78BC", en:"the qq number is invalid", ru:"\u043d\u0435\u0440\u043f qq"};
        ...
        return{builder:function () {
            ...
            var param = {c:E.compId, command:"leaveMessage", g:this.group || "", u:E.uId, v:E.vId, ct:E.counter, site:site, category:0, _mark:E._mark, token:obj.token};
    ...
    var parseEnv = function (o) {
        ...
        var ct = o.ct || cts && cts.length && cts[1] || 0;
        var ev = {uId:o.id || localdb.match(/^([^_]+)/) || E.vId, vId:o.vid && parsev() || getl("v") || ++ct && E.vId, counter:ct, refer:!refer || sameSite(refer) ? getl("ref") : refer, p0:getl("p0") || docurl, reseve:(typeof reseveKey == "undefined" ? (getl("r") || guessR()) : reseveKey)};
    ...
    D.start = function () {
        ...
        D.msgParam && (msgp = new MsgPanel(D.msgParam)) && msgp.builder().start();
    ...
    ready(function () {
        ...
        if (snf) {
            var ids = snf.ids.split(","), lb = "looyu_bound", gids = snf.gids.split(","), regStr = snf.ids.replace(/([\.\-\[\]\{\}\?\(\)\|])/ig, function ($0, $1) {
                return"\\" + $1
            }), reg = new RegExp(regStr.replace(/,/ig, "|"), "ig");
            ...
            var snifferNode = function (nd) {
                ...
                if (nd.nodeType == 3 && o_p.nodeName != "A") {
                    ...
                    span.innerHTML = nd.data.replace(reg, function ($0) {
                        return'<a href="#" onclick="doyoo.util.openChat(\'g=' + idg[$0] + "');return false\">" + $0 + "</a>"
                    });
