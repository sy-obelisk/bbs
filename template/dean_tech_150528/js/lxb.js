...
lxb.add("util", function (e) {
    ...
    e.visitorLog = function (s, m) {
        ...
        var n = "http://lxbjs.baidu.com/vt/lxb.gif";
    ...
    var g = e.base64 = function (o) {
        ...
        while (n < o.length) {
            ...
            m = m + _keyStr.charAt(u) + _keyStr.charAt(s) + _keyStr.charAt(q) + _keyStr.charAt(p)
        }
        return m
    };
    ...
    e.loadBPA = function () {
        ...
        n.onload = n.onreadystatechange = function () {
            ...
            if ("undefined" == typeof q || q == "loaded" || q == "complete") {
                m = 1;
                try {
                    bpaMonitor && bpaMonitor.startRecord()
                } finally {
    ...
    e.bpaLog = function () {
        ...
        var m = "http://bpa.baidu.com/bpa/bpa.gif";
        var o = bpaMonitor.getData();
        var n = function () {
            if (!i) {
                i = document.createElement("div");
                i.style.display = "none"
            }
            i.innerHTML = '<form action="' + m + '" method="post" target="bpaHideIframe"><input name="p" value="' + o + '"/></form><iframe id="bpaHideIframe" name="bpaHideIframe" src="about:blank"></iframe>';
            if (document.body) {
                document.body.appendChild(i);
                b = i.getElementsByTagName("form")[0];
                b.submit()
            }
        };
        n()
...
lxb.add("config", function (a) {
    var c = lxb.use("base");
    var e = {BDCBID:'452e82ab-ea78-4bcd-ace9-294caca2980a', LXBVT:0, TEMPSITEID:'5744656', TEMPPORT:'lxbjs.baidu.com/', TEMPFILEROOT:'float'};
    var b = {BDCBID:"bdcbid", LXBVT:1, TEMPSITEID:"siteid", TEMPPORT:"localhost:7778", TEMPFILEROOT:"/float"};
    c.extend(b, e);
...
lxb.add("tip", function (d) {
    ...
    var j = function () {
        l = {arrow:null, close:null, con:null, tipEle:null, value:10}
    };
    var a = function () {
        if (document.compatMode == "BackCompat") {
            return{width:document.body.clientWidth, height:document.body.clientHeight}
    ...
    var i = function (m) {
        return{width:m.offsetWidth, height:m.offsetHeight, top:m.offsetTop, left:m.offsetLeft}
    };
    var e = function (m) {
        return{width:m.offsetWidth, height:m.offsetHeight, top:m.offsetTop, left:m.offsetLeft}
    };
...
lxb.add("business.container", function (e) {
    ...
    e.init = function (m, n) {
        ...
        b();
        d();
        return{main:k.main, btnShow:k.btnShow}
    }
});
...
lxb.add("business.pin", function (g) {
    ...
    function b() {
        var r = o.main = c.create("ins", {className:k.MAIN + "-pin-con"});
...
lxb.add("business.callback", function (r) {
    ...
    function s() {
        ...
        var u = k.input = i.create("input", {type:"text", name:"phone", className:f.CB_INPUT, maxlength:12, value:l});
        ...
        if (b.displayGroup()) {
            ...
            for (var v = 0; v < g.groupDetail.length; v++) {
                var A = i.create("ins", {groupid:g.groupDetail[v].groupid, title:"\u514D\u8D39\u56DE\u7535", className:"lxb-group-btn"});
    ...
    function j(y, x) {
        ...
        var A = {vtel:y, siteid:g.siteid, bdcbid:u, refer_domain:g.refer};
        if (x) {
            A.g = x
        }
    ...
    function p() {
        lxb.use("base").create("img", {src:lxb.use("config").Root + "/count.gif?t=o"})
    }
...
lxb.add("business.invite", function (d) {
    ...
    d.schedule = function () {
        ...
        j.push({delay:l, callback:function () {
            d.invite()
        }});
        j.push({delay:m, callback:function () {
            d.minimize()
        }});
        p--;
        for (var o = 0; o < p; o++) {
            j.push({delay:n, callback:function () {
                d.invite()
            }});
            j.push({delay:m, callback:function () {
                d.minimize()
    ...
    d.getOptions = function () {
        var l = {"lxb-invite":{marginTop:(function () {
            var m = 0;
            var n = 0;
            if (e.background == 1) {
                m = e.height;
        ...
        })(), color:"#000", borderRadius:"3px", mozBorderRadius:"3px", webkitBorderRadius:"3px"}, "lxb-tl-phone":{width:"auto", fontFamily:(function () {
            switch (e.telFont - 0) {
                case 0:
                    return"\u5b8b\u4f53";
                case 1:
        ...
        })(), textAlign:"center", position:"static", margin:"10px 10px 0 10px", color:e.telColor, lineHeight:"1.2em", fontSize:e.telSize + "px"}, "lxb-tl-phone-em":{fontFamily:(function () {
            switch (e.telFont - 0) {
                case 0:
                    return"\u5b8b\u4f53";
                case 1:
        ...
        })(), color:e.telColor, lineHeight:"1.2em", fontSize:e.telSize + "px"}, "lxb-callback-container":{textAlign:"center", paddingBottom:(function () {
            if (f.displayGroup()) {
                if (f.displayLink()) {
                    return"30px"
                } else {
        ...
        })()}, "lxb-cb-input":{width:"130px", height:"22px", display:"inline-block", _display:"inline", _zoom:"1", color:"#000", margin:0, marginRight:"5px", lineHeight:"17px", top:"auto", left:"50%", bottom:"15px", position:"static", verticalAlign:"middle", borderRadius:"0px", mozBorderRadius:"0px", webkitBorderRadius:"0px", backgroundColor:"#fff"}, "lxb-cb-input-btn":{display:(function () {
            if (f.displayGroup()) {
                return"none"
            } else {
                return"inline-block"
...
(function () {
    ...
    function i(s) {
        ...
        e.base = {position:s.position, groupDetail:s.groupDetail, windowLayout:s.windowLayout, style:s.style, type:r};
        if (j.isStandard()) {
            if (j.isVertical()) {
        ...
        if (j.isCustom()) {
            e.custom = {url:s.imagePath, windowLayout:s.windowLayout, position:s.position, type:r};
            e.base.style = "custom";
            e.base.imagePath = s.imagePath
        }
        if (j.display400()) {
            e.tel = {phone:s.phone, mode:s.mode, format:s.format, ext:s.ext};
            if (j.isCustom()) {
        ...
        if (j.displayCallback()) {
            e.callback = {callPhone:s.cbPhone || "", style:s.style, btnFontContent:s.btnFontContent, siteid:s.siteid, btnfontColor:s.btnfontColor, btnColor:s.btnColor, styleType:s.styleType, windowLayout:s.windowLayout, ifGroup:s.ifGroup, groupDetail:s.groupDetail, code:s.code, refer:p || ""}
        }
        if (t !== 0) {
            s.inviteInfo = s.inviteInfo || {};
            s.inviteWay = s.inviteWay || {};
            e.invite = {ifGroup:s.ifGroup, vertical:s.position, windowLayout:s.windowLayout, status:s.inviteInfo.status || 0, content:s.inviteInfo.content || "", font:s.inviteInfo.font || 0, fontSize:s.inviteInfo.fontSize || 16, fontColor:s.inviteInfo.fontColor || "#000000", background:s.inviteInfo.background || 1, backgroundColor:s.inviteInfo.backgroundColor || "rgb(197, 232, 251)", backgroundImg:s.inviteInfo.backgroundImg || "", btnColor:s.inviteInfo.btnColor || "rgb(132, 133, 134)", btnFontColor:s.inviteInfo.btnFontColor || "#ffffff", telFont:s.inviteInfo.telFont || 0, telSize:s.inviteInfo.telSize || 18, telColor:s.inviteInfo.telColor || "#000000", height:s.inviteInfo.height || 140, width:s.inviteInfo.width || 230, imgHeight:s.inviteInfo.imgHeight || 140, imgWidth:s.inviteInfo.imgWidth || 230, position:s.inviteInfo.position || 0, linkStatus:s.inviteInfo.linkStatus || 0, linkURL:s.inviteInfo.linkURL, linkTextContent:s.inviteInfo.linkTextContent || "", linkTextColor:s.inviteInfo.linkTextColor || "#000000", linkTextFont:s.inviteInfo.linkTextFont || 0, linkBtnContent:s.inviteInfo.linkBtnContent || "在线交谈", linkBtnBgColor:s.inviteInfo.linkBtnBgColor || "#000000", linkBtnFontColor:s.inviteInfo.linkBtnFontColor || "#ffffff", ifStartPage:s.inviteWay.ifStartPage || 0, stayTime:s.inviteWay.stayTime || 0, inviteTimes:s.inviteWay.inviteTimes || 1, inviteInterval:s.inviteWay.inviteInterval || 0, closeTime:s.inviteWay.closeTime || 0, siteId:s.inviteWay.siteId}
        }
        return e
    }
    ...
    var h = {siteid:g.SiteId, bdclickid:n || "", bdcbid:q || "", refer_domain:p || ""};
    m.send(a, h, d);
