...
function tiaozhuan(){
    var val=document.getElementsByClassName("changeC")[0].innerHTML;
    var inputVal=document.getElementById("scbar_txt").value;
    var btn=document.getElementById("scbar_btn");
    btn.type="button";
    if(val=='题库'){
        location.href='http://www.gmatonline.cn/index.php?web/exam/timu_list&keywords='+encodeURIComponent(inputVal);
    }else if(val=='帖子'){
        btn.type="submit";
    }
}
