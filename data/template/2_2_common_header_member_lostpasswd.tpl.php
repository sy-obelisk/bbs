...
0
|| checktplrefresh('./template/dean_tech_150528/common/header.htm', './template/default/common/header_common.htm', 1454868173, '2', './data/template/2_2_common_header_member_lostpasswd.tpl.php', './template/dean_tech_150528', 'common/header_member_lostpasswd')
|| checktplrefresh('./template/dean_tech_150528/common/header.htm', './template/default/common/header_qmenu.htm', 1454868173, '2', './data/template/2_2_common_header_member_lostpasswd.tpl.php', './template/dean_tech_150528', 'common/header_member_lostpasswd')
;?>
...
<div class="topFont">
    <div>
        ...
        <ul>
            <li><a href="http://www.gmatonline.cn/beikao/#beikao">GMAT备考资讯</a></li>
            <li>|</li>
            <li><a href="http://www.gmatonline.cn/beikao/#beikao">GMAT高分经验</a></li>
            <li>|</li>
            <li><a href="http://www.gmatonline.cn/beikao/#beikao">GMAT备考技巧</a></li>
            <li>|</li>
            <li><a href="http://www.gmatonline.cn/beikao/#examination">GMAT考试指南</a></li>
        </ul>
    </div>
</div>
