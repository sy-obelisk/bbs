...
0
|| checktplrefresh('./template/dean_tech_150528/common/header.htm', './template/default/common/header_common.htm', 1446100419, '2', './data/template/2_2_common_header_home_misc.tpl.php', './template/dean_tech_150528', 'common/header_home_misc')
|| checktplrefresh('./template/dean_tech_150528/common/header.htm', './template/default/common/header_qmenu.htm', 1446100419, '2', './data/template/2_2_common_header_home_misc.tpl.php', './template/dean_tech_150528', 'common/header_home_misc')
;?>
...
<div class="topFont">
    <div>
        <span>互联网GMAT一站式在线学习平台</span>
        <ul>
            <li><a href="http://www.gmatonline.cn/index.php?web/index/news#beikao">GMAT备考资讯</a></li>
            <li>|</li>
            <li><a href="http://www.gmatonline.cn/index.php?web/index/news#beikao">GMAT高分经验</a></li>
            <li>|</li>
            <li><a href="http://www.gmatonline.cn/index.php?web/index/news#beikao">GMAT备考技巧</a></li>
            <li>|</li>
            <li><a href="http://www.gmatonline.cn/index.php?web/index/news#examination">GMAT考试指南</a></li>
        </ul>
    </div>
</div>
<div class="deanheader" id="deanheader">
    <div class="deanwp">
        ...
        <?php $mnid = getcurrentnav();?>        <div class="deandenglu">
            <div class="tiku_xiala">
                <a href="http://www.gmatonline.cn/index.php?web/exam/timu_list"  target="_blank" class="tiku_head_font">题库</a>
                <!--鼠标移到按钮显示遮-->
                <div class="zN_zzc">
                    <ul>
                        <li>
                            <a href="http://www.gmatonline.cn/index.php?web/exam/timu_list&amp;section=6" target="_blank">句子改错  Sentence Correction </a>
                        </li>
                        <li>
                            <a href="http://www.gmatonline.cn/index.php?web/exam/timu_list&amp;section=8" target="_blank">逻辑  Critical Reasoning</a>
                        </li>
                        <li>
                            <a href="http://www.gmatonline.cn/index.php?web/exam/timu_list&amp;section=7" target="_blank">阅读   Reading Comprehension </a>
                        </li>
                        <li>
                            <a href="http://www.gmatonline.cn/index.php?web/exam/timu_list&amp;section=4" target="_blank">数学  Problem Solving</a>
                        </li>
                        <li>
                            <a href="http://www.gmatonline.cn/index.php?web/exam/timu_list&amp;section=5" target="_blank">数学   Data Sufficiency</a>
                        </li>
                        <li>
                            <a href="http://www.gmatonline.cn/index.php?web/exam/timu_list&amp;section=10" target="_blank">作文  Argument</a>
                        </li>
                        <li>
                            <a href="http://www.gmatonline.cn/index.php?web/exam/timu_list&amp;section=11" target="_blank">综合推理 Integrated Reasoning</a>
                        </li>
                    </ul>
                </div>
            </div>
            <p class="phoneIcon"><img src="template/dean_tech_150528/images/index_purPhone.png" alt="电话图标"/> 400-1816-180</p>
...
<div class="deannav head_nav" >
    <ul>
        ...
        <li <?php if($mnid == $nav['navid']) { ?>class="a on" <?php } ?><?php echo $nav['nav'];?>></li>
