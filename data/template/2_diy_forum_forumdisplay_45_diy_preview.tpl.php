<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('forumdisplay_45_diy_preview');
0
|| checktplrefresh('data/diy/./template/dean_tech_150528//forum/forumdisplay_45_diy_preview.htm', './template/dean_tech_150528/common/pubsearchform.htm', 1446084681, 'diy', './data/template/2_diy_forum_forumdisplay_45_diy_preview.tpl.php', 'data/diy/./template/dean_tech_150528/', 'forum/forumdisplay_45_diy_preview')
|| checktplrefresh('data/diy/./template/dean_tech_150528//forum/forumdisplay_45_diy_preview.htm', './template/default/forum/recommend.htm', 1446084681, 'diy', './data/template/2_diy_forum_forumdisplay_45_diy_preview.tpl.php', 'data/diy/./template/dean_tech_150528/', 'forum/forumdisplay_45_diy_preview')
|| checktplrefresh('data/diy/./template/dean_tech_150528//forum/forumdisplay_45_diy_preview.htm', './template/default/common/seccheck.htm', 1446084681, 'diy', './data/template/2_diy_forum_forumdisplay_45_diy_preview.tpl.php', 'data/diy/./template/dean_tech_150528/', 'forum/forumdisplay_45_diy_preview')
|| checktplrefresh('data/diy/./template/dean_tech_150528//forum/forumdisplay_45_diy_preview.htm', './template/default/forum/forumdisplay_list.htm', 1446084681, 'diy', './data/template/2_diy_forum_forumdisplay_45_diy_preview.tpl.php', 'data/diy/./template/dean_tech_150528/', 'forum/forumdisplay_45_diy_preview')
|| checktplrefresh('data/diy/./template/dean_tech_150528//forum/forumdisplay_45_diy_preview.htm', './template/default/forum/forumdisplay_sort.htm', 1446084681, 'diy', './data/template/2_diy_forum_forumdisplay_45_diy_preview.tpl.php', 'data/diy/./template/dean_tech_150528/', 'forum/forumdisplay_45_diy_preview')
|| checktplrefresh('data/diy/./template/dean_tech_150528//forum/forumdisplay_45_diy_preview.htm', './template/default/forum/search_sortoption.htm', 1446084681, 'diy', './data/template/2_diy_forum_forumdisplay_45_diy_preview.tpl.php', 'data/diy/./template/dean_tech_150528/', 'forum/forumdisplay_45_diy_preview')
|| checktplrefresh('data/diy/./template/dean_tech_150528//forum/forumdisplay_45_diy_preview.htm', './template/default/forum/search_sortoption.htm', 1446084681, 'diy', './data/template/2_diy_forum_forumdisplay_45_diy_preview.tpl.php', 'data/diy/./template/dean_tech_150528/', 'forum/forumdisplay_45_diy_preview')
;
block_get('13,9,10,16,17');?>
﻿<?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_moderate.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_9 .dxb_bc { color:#424451 !important;font-size:14px !important;margin-top:8px !important;margin-right:8px !important;margin-bottom:8px !important;margin-left:0px !important;}</style>
        ...
        <?php if($_G['fid'] == 45 ) { ?>
            ...
            <div id="chart" class="bm bw0 cl" >
                ...
                <!--<div class="bright">-->
                    ...
                    <span compare="<?php echo $postdata['0'];?>">昨日发贴：<span class="light">

                        <!--<?php echo $_G['forum']['yesterdayposts'];?>-->
                        4
                    </span></span><span class="pipe">|</span>
                    <span>贴子总数：<span class="light">
                        7082
                    </span></span><span class="pipe">|</span>
                    <span>欢迎新成员：<span>Sophia</span></span>
                <!--</div>-->
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
                        <a href="http://www.gmatonline.cn/index.php?web/exam/" target="_blank" title="雷哥GMAT在线题库 做题拿直播课名额"><img
                                src="template/dean_tech_150528/images/luntan_lunbo01.jpg" title="雷哥GMAT在线题库 做题拿直播课名额" alt="雷哥GMAT在线题库 做题拿直播课名额"></a>
                    </div>

                    <div class="item">
                        <a href="http://www.gmatonline.cn/index.php?web/ceping" target="_blank" title=" 雷哥GMAT在线智能测评"><img
                                src="template/dean_tech_150528/images/luntan_lunbo02.jpg" title=" 雷哥GMAT在线智能测评" alt=" 雷哥GMAT在线智能测评"></a>
                    </div>

                    <div class="item">
                        <a href="http://www.gmatonline.cn/index.php?web/publicclass/index&amp;catid=2" target="_blank" title="概率精品直播课"><img
                                src="template/dean_tech_150528/images/luntan_lunbo03.jpg" title="概率精品直播课" alt="概率精品直播课"></a>
                    </div>
...
<div class="drag">
<!--[diy=diy4]--><div id="diy4" class="area"><div id="frame1o21I9" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">功能板块</span></div><div id="frame1o21I9_left" class="column frame-1-c"><div id="frame1o21I9_left_temp" class="move-span temp"></div><?php block_display('13');?></div></div></div><!--[/diy]-->
</div>
...
//            var signInUrl = "http://bbs.xsteach.com/experience/sign-in";
                ...
                <div class="ad mrt50">
                    <div id="carousel-example-generic3" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active"><a href="http://www.gmatonline.cn/index.php?web/exam/" target="_blank"><img
                            ...
                            <div class="item"><a href="http://www.gmatonline.cn/index.php?web/publicclass/index&amp;catid=2" target="_blank"><img
                                    src="template/dean_tech_150528/images/luntan_small03.jpg" title="概率精品直播课" alt="概率精品直播课"></a></div>
            ...
            <!--[diy=diyfastposttop]--><div id="diyfastposttop" class="area"><div id="tab4g2yRn" class="frame-tab move-span cl"><div id="tab4g2yRn_title" class="tab-title title column cl" switchtype="click"><span class="titletext">热帖排行</span><?php block_display('9');?><?php block_display('10');?></div><div id="tab4g2yRn_content" class="tb-c"></div><script type="text/javascript">initTab("tab4g2yRn","click");</script></div><div id="tabFlJ4uS" class="frame-tab move-span cl"><div id="tabFlJ4uS_title" class="tab-title title column cl" switchtype="click"><span class="titletext">社区之星</span><?php block_display('16');?><?php block_display('17');?></div><div id="tabFlJ4uS_content" class="tb-c"></div><script type="text/javascript">initTab("tabFlJ4uS","click");</script></div></div><!--[/diy]-->
            <script>
                $(function () {
